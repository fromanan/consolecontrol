...
public class KeyMapping
{
    ...
    public KeyMapping(bool control, bool alt, bool shift, Keys keyCode, string? sendKeysMapping,
    ...
    public bool IsKeyMatch(KeyEventArgs e)
    {
        return KeyCode == e.KeyCode && IsAltPressed == e.Alt && IsControlPressed == e.Control && IsShiftPressed == e.Shift;
    }
}